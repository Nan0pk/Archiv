"""Legacy binary Microsoft Office normalization: ``.xls``, ``.doc``, and ``.ppt``.

``.xls`` (Excel 97-2003 / BIFF8) parsing uses ``xlrd``, which parses the BIFF
...
__all__ = ["normalize_doc", "normalize_ppt", "normalize_xls"]
